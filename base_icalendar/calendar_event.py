...
from property import icalendar_property
...
class CalendarEvent(orm.Model):
    _inherit = ['calendar.event', 'icalendar.component.model']
    _name = 'calendar.event'

    def _get_icalendar_component_mapping(self):
        """Defines mapping between iCalendar component and model properties."""
        return super(CalendarEvent, self)._get_icalendar_component_mapping() + \
